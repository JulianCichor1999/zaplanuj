<?php
    ...
    if(isset($_POST['login']) && isset($_POST['haslo'])){
        $ResponseLogin = User_Log_In($_POST['login'],$_POST['haslo']);
...
<form action="" method="post" class="form-container">
    <div class="form-group">
        ...
        <input type="submit" value="Zaloguj się" class="btn btn-block" style="background-color:#FFEFBA;"/>
    </div>
<?php
    if($ResponseLogin){
        echo $ResponseLogin['message'];
    }
?>
</form>